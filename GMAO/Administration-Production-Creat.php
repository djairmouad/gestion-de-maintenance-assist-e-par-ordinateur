...
<div class="conatiner"  style="width: 100%;
    ...
    <div class="header-2" id="header">
        <div class="container">
            <ul class="link2">
                <li><a href="Administration-Production-Creat.php" class="active">Creat Production</a></li>
                <li><a href="Administration-Production.php" >List</a></li>
            </ul>
        </div>
    </div>
<div class="information active" id="information">
        <form action="" method="post">
            ...
            <div class="info">
                <div class="info-2">
                    <label for="">Last Name of Production Director:</label>
            ...
            <div class="info" style="flex-direction: row;">
                <input type="submit" value="Save" style="width: 28.5%;" name="save" formaction="./dataBase/save/saveProduction.php">
            </div>
        </form>
        <div class="image">
