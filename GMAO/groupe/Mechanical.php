...
if ($id !== ""){
    ...
    AND (formulaire.summary_Mechanical IS NULL OR formulaire.summary_Mechanical = '');";
...
<body>
    ...
    <h2>  Mechanical:</h2> <table id="requests-table">
        <thead>
            <tr>
                <th>Number</th>
                <th>Type</th>
...
<?php endif; ?>
        ...
        <div class="box">
            ...
            <div class="info">
                <div class="info-2">
                    <label for="date">DATE/HOUR(Mechanical):</label>
