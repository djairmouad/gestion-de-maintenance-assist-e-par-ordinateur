...
if ($id !== ""){
    ...
    AND (formulaire.summary_Hydraulic IS NULL OR formulaire.summary_Hydraulic = '');";
...
<body>
    <div class="header" id="header">
        <div class="container">
            ...
            <div class="links">
            <ul class="link">
                <li><a href="Hydraulic.php" class="active">Request For Intervention</a></li>
            </ul>
            <ul class="link_2">
...
<?php endif; ?>
        ...
        <div class="box">
            ...
            <div class="info">
                <div class="info-2">
                    <label for="date">DATE/HOUR(Hydraulic):</label>
