...
if ($id !== ""){
    ...
    AND (formulaire.summary_Electric IS NULL OR formulaire.summary_Electric = '');";
...
<body>
    <div class="header" id="header">
        <div class="container">
            ...
            <div class="links">
            <ul class="link">
                <li><a href="Electric.php" class="active">Request For Intervention</a></li>
            </ul>
            <ul class="link_2">
...
<?php endif; ?>
        ...
        <div class="box">
            ...
            <div class="info">
                <div class="info-2">
                    <label for="date">DATE/HOUR(Electric):</label>
