...
<body>
    <div class="header" id="header">
        <div class="container">
            ...
            <ul class="link">
                ...
                <li><a href="Administration-Magasin.php" >Magasin</a></li>
                <li><a href="Administration-achat.php" class="active">Purchase</a></li>
            </ul>
            <ul class="link_2">
                <li>
                    <a href="Login.php">
    ...
    <div class="information">
        <form action="" method="post">
           ...
           <div class="info">
            <div class="info-2">
            <label for="">  first Name of purchase Director:</label>
            <input type="text" class="name">
            </div>
           </div>
           <div class="info">
            <div class="info-2">
                <label for=""> Last Name of purchase Director:</label>
                <input type="text" class="name">
                </div>
           </div>
           <div class="info">
         ...
         <div class="image">
            <img src="image/Homme-et-ordinateur-2-14-1-500x0-c-default.png" alt="">
           </div>
    </div>
